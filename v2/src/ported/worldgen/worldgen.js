...
import { decodeWalks } from "./walkData.js";
...
let landShape=null;let walks=null;
if(preset==="earth"){
// ── Earth mode: use real heightmap data ──
const eData=decodeEarth(EARTH_ELEV);
const fData=decodeLandFrac(LAND_FRAC,eData);landFraction=new Float32Array(W*H);landShape=decodeLandShape(LAND_SHAPE);walks=decodeWalks(W,H);crossings=decodeCrossings(W,H);
