/* V2 M1 PORT
 * source: src/sim/biomeClass.js; deviations: Math transcendental calls use v2 dmath.
 * source commit: 97f51dd7c3a3142bfbb366f2e08491f582367e30
 */
import { dln, dexp } from "../../sim/dmath.ts";
...
export function bioTemp(t) {
  return Math.min(30, BIO_K * dln(1 + dexp(((t - 0.6) * 100) / BIO_K)));
}
