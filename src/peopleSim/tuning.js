...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "ABSORB_PROB_MAX", label: "Absorption max rate", def: 0.04, min: 0.01, max: 0.3, step: 0.01,
      ...
      { key: "ABSORB_RATE", label: "Absorption pressure", def: 0.018, min: 0.005, max: 0.1, step: 0.005,
      ...
      { key: "ABSORB_DOMINANCE", label: "Absorption dominance gate", def: 3.2, min: 1.05, max: 5.0, step: 0.05,
