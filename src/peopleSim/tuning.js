...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      { key: "CAP_BASE", label: "Capital base reach", def: 6, min: 1, max: 30, step: 0.5,
      ...
      { key: "LOYAL_DECAY", label: "Disloyalty speed", def: 0.10, min: 0.01, max: 0.5, step: 0.01,
        desc: "How fast an over-extended (uncovered) province bleeds loyalty toward revolt. Up = fragile frontiers." },
