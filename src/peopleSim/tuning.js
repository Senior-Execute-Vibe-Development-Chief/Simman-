...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      { key: "CAP_BASE", label: "Capital base reach", def: 2.5, min: 1, max: 30, step: 0.5,
      ...
      { key: "CAP_ORG", label: "Bureaucratic capacity", def: 1.5, min: 0, max: 24, step: 0.5,
      ...
      { key: "ABSORB_DOMINANCE", label: "Absorption dominance gate", def: 2.4, min: 1.05, max: 5.0, step: 0.05,
      ...
      { key: "LOYAL_ORG_HOLD", label: "Imperial cohesion (loyalty)", def: 0.2, min: 0, max: 0.9, step: 0.05,
      ...
      { key: "DURESS_RESILIENCE", label: "Wartime resilience (org)", def: 0.35, min: 0, max: 0.9, step: 0.05,
      ...
      { key: "ORG_REACH", label: "Reach per organization tech", def: 20, min: 5, max: 120, step: 5,
