...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "CAP_POP", label: "Big-capital bonus", def: 0.8, min: 0, max: 8, step: 0.25,
      ...
      { key: "CAP_ORG", label: "Bureaucratic capacity", def: 0.8, min: 0, max: 24, step: 0.5,
      ...
      { key: "ABSORB_DOMINANCE", label: "Absorption dominance gate", def: 3.0, min: 1.05, max: 5.0, step: 0.05,
      ...
      { key: "LOYAL_ORG_HOLD", label: "Imperial cohesion (loyalty)", def: 0.1, min: 0, max: 0.9, step: 0.05,
      ...
      { key: "DURESS_RESILIENCE", label: "Wartime resilience (org)", def: 0.2, min: 0, max: 0.9, step: 0.05,
      ...
      { key: "CAP_SEAT", label: "Regional seat capacity", def: 0.5, min: 0, max: 4, step: 0.1,
      ...
      { key: "ORG_REACH", label: "Reach per organization tech", def: 12, min: 5, max: 120, step: 5,
        desc: "Tiles of land-claim & admin reach gained per point of organization knowledge. Scales empire size with the era." },
      { key: "LOYAL_DECAY", label: "Disloyalty speed", def: 0.2, min: 0.01, max: 0.5, step: 0.01,
