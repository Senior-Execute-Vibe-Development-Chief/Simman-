...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "CAP_ORG", label: "Bureaucratic capacity", def: 4, min: 0, max: 24, step: 0.5,
      ...
      { key: "ABSORB_DOMINANCE", label: "Absorption dominance gate", def: 1.8, min: 1.05, max: 5.0, step: 0.05,
