...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "LOYAL_ORG_HOLD", label: "Imperial cohesion (loyalty)", def: 0.05, min: 0, max: 0.9, step: 0.05,
      ...
      { key: "LOYAL_DECAY", label: "Disloyalty speed", def: 0.3, min: 0.01, max: 0.5, step: 0.01,
