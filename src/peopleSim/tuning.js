...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "LUX_VILLAGE_FRAC", label: "Village luxury appetite", def: 0.1, min: 0, max: 1, step: 0.05,
        desc: "Luxury goods (silk, spices, furs, dyes) are URBAN/elite consumption. A tier-0 farming village is a subsistence peasant community, so even a cash-rich one buys only this fraction of the luxury a town/city would for the same spare wealth (it saves/reinvests instead). 0.1 = villages buy ~a tenth as much luxury; 1 = villages buy like cities (the old behaviour, where wealthy villages oddly imported spices)." },
