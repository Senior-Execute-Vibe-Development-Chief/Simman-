...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "advectionStrength", def: 1.0, min: 0.0, max: 2.0, label: "Convergence boost",
        desc: "Conservation of mass: where winds converge, air speeds up. Where winds diverge, air slows. 0 = winds don't interact. 1 = realistic. >1 = exaggerated funneling and jet effects." },
      ...
      { key: "coandaPull", def: 0.003, min: 0.0, max: 0.02, label: "Coanda pull",
        desc: "How strongly wind flowing past terrain gets attracted to follow the surface. Creates wrapping around capes and points. 0 = no attraction. Higher = wind hugs terrain contours more." },
