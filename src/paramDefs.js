...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "windAltitude", def: 0.02, min: 0.0, max: 0.15, label: "Wind altitude",
        desc: "Elevation subtracted from terrain before wind interacts with it. Simulates wind flowing at a height above ground. At 0.02 (~175m), lowlands under 175m are invisible to wind. At 0.10 (~885m), only peaks above 885m block wind. 0 = surface wind." },
