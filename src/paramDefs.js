...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "curlBoost", def: 1.5, min: 0.0, max: 10.0, label: "Curl boost",
        desc: "Speed boost in areas with high rotation (vorticity). Ocean only — cyclones intensify over warm ocean, weaken over land. Makes swirling areas have faster winds like real cyclones. 0 = no effect." },
      { key: "curlThreshold", def: 0.3, min: 0.0, max: 2.0, label: "Curl threshold",
        desc: "Minimum rotation intensity before curl boost kicks in. Higher = only the strongest swirls get boosted. Lower = more widespread speed-up in rotating areas." },
