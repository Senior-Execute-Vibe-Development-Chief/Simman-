...
export const PARAMS = {
  plates: {
    ...
    params: [
      ...
      { key: "numMinorBase", def: 8, min: 2, max: 14, step: 1, label: "Minor plates (base)",
  ...
  continents: {
    ...
    params: [
      ...
      { key: "minorContRadMin", def: 0.07, min: 0.02, max: 0.14, label: "Minor continent min radius",
        desc: "Minimum island/micro-continent size." },
      { key: "minorContRadRange", def: 0.08, min: 0.02, max: 0.14, label: "Minor continent radius range",
      ...
      { key: "warpStr1", def: 0.18, min: 0.02, max: 0.30, label: "Coastline warp (large)",
