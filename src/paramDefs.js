...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "thermalContrast", def: 0.6, min: 0.0, max: 1.5, label: "Land-sea thermal contrast",
      ...
      { key: "hadleyStrength", def: 1.0, min: 0.0, max: 2.0, label: "Hadley cell strength",
      ...
      { key: "monsoonStrength", def: 0.5, min: 0.0, max: 1.5, label: "Monsoon strength",
      ...
      { key: "landDrag", def: 0.12, min: 0.03, max: 0.8, label: "Land friction",
        desc: "Surface drag over lowland terrain. Mountains get extra drag automatically. Wind still blows across deserts and plains at low values. Higher = weaker winds over all land." },
      { key: "terrainDeflect", def: 5.0, min: 1.0, max: 15.0, label: "Terrain deflection",
        desc: "Froude number scaling for orographic blocking. Controls whether wind goes over or around mountains. Higher = more blocking. 2000m mountains fully block at default." },
      { key: "gapFunneling", def: 0.5, min: 0.0, max: 1.5, label: "Gap funneling",
      ...
      { key: "eddyStrength", def: 0.015, min: 0.0, max: 0.06, label: "Eddy strength",
        desc: "Sub-grid mesoscale turbulence (curl noise). Ocean gets full value, land gets 40%. Adds realistic local variation." },
      ...
      { key: "windSolverIter", def: 40, min: 8, max: 500, step: 1, label: "Solver iterations",
