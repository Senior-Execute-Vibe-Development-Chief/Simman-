...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "landDrag", def: 0.06, min: 0.02, max: 0.5, label: "Land friction",
      ...
      { key: "absorption", def: 0.5, min: 0.0, max: 1.0, label: "Coastal absorption",
      ...
      { key: "deflection", def: 25.0, min: 0.0, max: 80.0, label: "Terrain deflection",
      ...
      { key: "windAltitude", def: 0.02, min: 0.0, max: 0.5, label: "Wind altitude",
