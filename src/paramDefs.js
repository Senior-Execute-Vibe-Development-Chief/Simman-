  ...
  wind: {
    ...
    params: [
      ...
      { key: "terrainDeflect", def: 5.0, min: 1.0, max: 15.0, label: "Terrain deflection",
        desc: "Froude number scaling (effective N×h). Controls whether wind goes over or around terrain. Higher = more blocking. At default: 2000m mountains fully block, 400m hills partially block, 200m barely affects flow." },
      { key: "convergenceFeedback", def: 0.15, min: 0.02, max: 0.5, label: "Convergence feedback",
        desc: "How strongly wind convergence (from friction slowdown) raises local pressure. THE mechanism that makes continents deflect wind — stronger = more deflection around land." },
