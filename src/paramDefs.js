...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "hadleyStrength", def: 0.38, min: 0.0, max: 2.0, label: "Hadley cell strength",
      ...
      { key: "landDrag", def: 3.606, min: 0.02, max: 5.0, label: "Land friction",
      ...
      { key: "gustThreshold", def: 0.085, min: 0.0, max: 0.5, label: "Gust threshold",
      ...
      { key: "gustBoost", def: 4.7, min: 0.0, max: 5.0, label: "Gust boost",
      ...
      { key: "curlBoost", def: 2.2, min: 0.0, max: 10.0, label: "Curl boost",
