...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "coandaStrength", def: 0.7, min: 0.0, max: 1.5, label: "Coanda strength",
        desc: "How much blocked wind energy redirects along the terrain surface. 0 = blocked energy disappears. 0.7 = 70% wraps around. >1 = exaggerated wrapping." },
      { key: "gustThreshold", def: 0.15, min: 0.0, max: 0.5, label: "Gust threshold",
      ...
      { key: "gustBoost", def: 0.3, min: 0.0, max: 2.0, label: "Gust boost",
