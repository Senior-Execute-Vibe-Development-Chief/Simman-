...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "landDrag", def: 0.80, min: 0.02, max: 2.0, label: "Land friction",
        desc: "Surface drag over land. Mountains get extra drag automatically scaled by elevation. Higher = weaker winds over all land." },
      { key: "terrainDeflect", def: 15.0, min: 0.0, max: 20.0, label: "Terrain deflection",
      ...
      { key: "eddyStrength", def: 0.04, min: 0.0, max: 0.06, label: "Eddy strength",
        desc: "Sub-grid mesoscale turbulence (curl noise). Ocean gets full value, land gets 50%. Adds realistic local variation." },
      { key: "windScale", def: 0.3, min: 0.1, max: 4.0, label: "Wind speed scale",
