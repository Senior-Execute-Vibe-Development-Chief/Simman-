...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      { key: "pressureScale", def: 1.45, min: 0.5, max: 10.0, label: "Pressure scale",
      ...
      { key: "hadleyStrength", def: 0.26, min: 0.0, max: 2.0, label: "Hadley cell strength",
      ...
      { key: "coriolisStrength", def: 0.32, min: 0.05, max: 0.50, label: "Coriolis strength",
      ...
      { key: "itczOffset", def: 0.03, min: -0.10, max: 0.15, label: "ITCZ offset",
      ...
      { key: "landDrag", def: 0.08, min: 0.02, max: 0.5, label: "Flat land friction",
        desc: "Surface drag over flat lowland terrain (deserts, plains, grassland). Controls how freely wind blows across open land. Low values let wind flow like over ocean." },
      { key: "mountainDrag", def: 0.6, min: 0.0, max: 2.0, label: "Mountain friction",
        desc: "Extra drag added for mountainous terrain, scaled by elevation. 0 = mountains don't slow wind beyond flat land drag. Higher = mountains create stronger friction zones." },
      { key: "terrainDeflect", def: 1.0, min: 0.0, max: 2.0, label: "Terrain deflection",
        desc: "How much terrain deflects wind flow. Controls both which terrain is tall enough to block wind and how strongly it deflects. 0 = no deflection. Low = only huge mountains. High = even moderate hills deflect wind." },
      ...
      { key: "windScale", def: 0.485, min: 0.1, max: 4.0, label: "Wind speed scale",
      ...
      { key: "windSolverIter", def: 248, min: 8, max: 500, step: 1, label: "Solver iterations",
