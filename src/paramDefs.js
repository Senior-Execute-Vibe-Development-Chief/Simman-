...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      { key: "pressureScale", def: 0.433, min: 0.05, max: 3.0, label: "Pressure scale",
      ...
      { key: "thermalContrast", def: 0.14, min: 0.0, max: 2.0, label: "Land-sea thermal contrast",
      ...
      { key: "hadleyStrength", def: 0.0, min: 0.0, max: 2.0, label: "Hadley cell strength",
      ...
      { key: "coriolisStrength", def: 0.50, min: 0.05, max: 0.50, label: "Coriolis strength",
      ...
      { key: "itczOffset", def: 0.013, min: -0.10, max: 0.15, label: "ITCZ offset",
      ...
      { key: "coandaStrength", def: 0.12, min: 0.0, max: 3.0, label: "Coanda strength",
      ...
      { key: "gustBoost", def: 2.0, min: 0.0, max: 5.0, label: "Gust boost",
      ...
      { key: "curlThreshold", def: 0.05, min: 0.0, max: 0.3, label: "Swirl threshold",
        desc: "Normalized vorticity below which swirl boost has no effect. Higher = only the most intense rotation gets boosted. Lower = more areas affected." },
      { key: "curlBoost", def: 2.0, min: 0.0, max: 10.0, label: "Swirl boost",
        desc: "Speed boost for areas spinning above the swirl threshold. The excess rotation above threshold gets amplified. Higher = much faster winds in cyclonic areas. No cap." },
      { key: "eddyStrength", def: 0.005, min: 0.0, max: 0.06, label: "Eddy strength",
