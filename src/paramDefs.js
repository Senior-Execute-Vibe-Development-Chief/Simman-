...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "landDrag", def: 0.20, min: 0.05, max: 0.50, label: "Land friction",
        desc: "Rayleigh drag over lowland terrain. Sets cross-isobar angle (~35° at default). Decreases with elevation (exposed peaks)." },
      ...
      { key: "orographicPressure", def: 2.5, min: 0.0, max: 8.0, label: "Orographic pressure",
        desc: "How much mountains add to surface pressure, creating windward highs and lee troughs. THE main control for continent-shaped wind patterns." },
      ...
      { key: "eddyStrength", def: 0.015, min: 0.0, max: 0.06, label: "Ocean eddy strength",
        desc: "Sub-grid curl noise eddies over ocean (land gets 40% of this). Parameterizes mesoscale turbulence the coarse solver can't resolve." },
