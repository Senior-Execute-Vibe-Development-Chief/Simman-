...
export const PARAMS = {
  ...
  wind: {
    ...
    params: [
      ...
      { key: "landDragMax", def: 0.50, min: 0.15, max: 0.80, label: "Land drag",
        desc: "Maximum surface friction over lowland terrain (sheltered valleys/forests). Decreases at higher elevations. All land drag > ocean drag." },
