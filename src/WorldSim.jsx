...
// ── Build land tile index (once, cached) ──
if(!ter._landTiles){
...
if(riverMag){const rm=riverMag[ti];if(rm>=3)myValue+=0.6;else if(rm>=2)myValue+=0.3;}
...
if(riverMag){const rm=riverMag[ni];if(rm>=3)nValue+=0.6;else if(rm>=2)nValue+=0.3;}
