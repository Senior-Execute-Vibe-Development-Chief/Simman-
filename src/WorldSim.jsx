...
// Base climate fertility: adequate warmth + adequate moisture, penalized by elevation.
// Uses a bell curve on moisture — too dry is bad, but too wet is also bad (leaching,
// waterlogging, dense vegetation competing with crops). Peak around 0.4-0.5 moisture.
function tileFert(t,m,e){
if(e>0.45)return 0.05;
// Temperature: need warmth for growing season, but diminishing returns above 0.5
const tFactor=Math.min(1,t*1.5)*Math.min(1,1.2-t*0.4);// peaks around 0.5-0.7
// Moisture: bell curve peaking at 0.45 — adequate rain without tropical excess
