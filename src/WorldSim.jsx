...
tGrid[my*mW2+mx]=Math.max(0,Math.min(1,1-lt*1.05-Math.max(0,e2)*0.65));}
...
const locT=Math.max(0,Math.min(1,1-lt*1.05-Math.max(0,e2)*0.65));
...
const bt=1-lat*1.05-Math.max(0,e)*0.65+fbm(nx*3+80,ny*3+80,3,2,.5)*.08+fbm(nx*1.2+55,ny*1.2+55,3,2,.55)*.10;
