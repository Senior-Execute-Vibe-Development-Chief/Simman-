...
temperature[i]=Math.max(0,Math.min(1,1-Math.pow(lat,1.4)*0.95-lat*lat*0.15-Math.max(0,elevation[i])*.4+fbm(nx*3+80,ny*3+80,3,2,.5)*.08));}
...
tGrid[my*mW2+mx]=Math.max(0,Math.min(1,1-Math.pow(lt,1.4)*0.95-lt*lt*0.15+Math.exp(-((lt-0.20)*(lt-0.20))/(2*0.08*0.08))*0.06-Math.max(0,e2)*0.65));}
...
const locT=Math.max(0,Math.min(1,1-Math.pow(lt,1.4)*0.95-lt*lt*0.15+Math.exp(-((lt-0.20)*(lt-0.20))/(2*0.08*0.08))*0.06-Math.max(0,e2)*0.65));
...
// Temperature targets: equator=1.0(40°C), 45°≈0.55(−5°C), Antarctic coast≈0.5(−10°C),
// Greenland south≈0.6(0°C), central Greenland≈0.2(−40°C), Antarctic center≈0.0(−60°C)
const bt=1-Math.pow(tLat,1.4)*0.95-tLat*tLat*0.15+shE-Math.max(0,e)*0.65+fbm(nx*3+80,ny*3+80,3,2,.5)*.08+fbm(nx*1.2+55,ny*1.2+55,3,2,.55)*.10;
...
moisture[i]=Math.max(.02,Math.min(1,m));
temperature[i]=Math.max(0,Math.min(1,1-Math.pow(lat,1.4)*0.95-lat*lat*0.15-Math.max(0,e)*.4+fbm(nx*3+80,ny*3+80,3,2,.5)*.1));}
...
elevation[i]=e;temperature[i]=Math.max(0,Math.min(1,1-Math.pow(lat,1.4)*0.95-lat*lat*0.15-Math.max(0,e)*.4+fbm(nx*3+80,ny*3+80,3,2,.5)*.1));}
