...
export function refProfile(kind, seed) {
  ...
  if (kind === "mandarin") Object.assign(p, {
    ...
    gram: {
      ...
      remotePast: 0, remoteFuture: 0, perfect: true, progressive: true, habitual: false, moods: [], mirative: false,
  ...
  if (kind === "russian") Object.assign(p, {
    ...
    gram: {
      ...
      remotePast: 0, remoteFuture: 0, perfect: false, progressive: false, habitual: false, moods: ["cond"], mirative: false,
