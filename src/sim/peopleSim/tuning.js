...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "ERA_PROD_SCALE", label: "Emergent productivity scale", def: 380, min: 0, max: 1000, step: 8,
      ...
      { key: "ERA_PROD_DEV0", label: "Productivity dev-gate floor", def: 0.22, min: 0, max: 0.9, step: 0.02,
      ...
      { key: "HOUSE_ERA_POW", label: "City housing vs productivity", def: 0.5, min: 0.2, max: 1, step: 0.05,
