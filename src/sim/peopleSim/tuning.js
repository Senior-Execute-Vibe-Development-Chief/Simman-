...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "ERA_PROD_SCALE", label: "Emergent productivity scale", def: 150, min: 0, max: 1000, step: 8,
      ...
      { key: "ERA_PROD_POW", label: "Emergent productivity back-loading", def: 8, min: 1, max: 16, step: 0.5,
      ...
      { key: "HOUSE_ERA_POW", label: "City housing vs productivity", def: 0.55, min: 0.2, max: 1, step: 0.05,
