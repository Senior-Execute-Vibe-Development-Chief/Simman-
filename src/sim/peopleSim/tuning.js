...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "ERA_PROD_SCALE", label: "Emergent productivity scale", def: 300, min: 0, max: 1000, step: 8,
      ...
      { key: "ERA_PROD_POW", label: "Emergent productivity back-loading", def: 6, min: 1, max: 16, step: 0.5,
        desc: "ANCHOR_POP=0 only. Exponent on agriculture knowledge in _eraProd = 1 + SCALE·agri^POW. High = the productivity lift stays near 1 through the forager/early-farming era and surges only as agriculture MODERNISES (the boom is sharp and late, riding the top of the tech tree); low = a gentler, earlier lift. 8 keeps deep antiquity near subsistence while the modern surge rides agriculture's last climb to 1.0." },
