...
export const TUNING_SCHEMA = [
  ...
  },
  {
    ...
    params: [
      ...
      { key: "ORG_APT_LEARN", label: "Aptitude → org-learning bonus", def: 0.6, min: 0, max: 2.0, step: 0.1,
        desc: "A full-aptitude population learns the ORGANISATION track this much faster (×(1+this)). Still capped by the material-era ceiling — aptitude reaches the cap sooner, it doesn't exceed it." },
