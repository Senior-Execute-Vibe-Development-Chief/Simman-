...
const MOTIFS = {
  beast: ["lion", "wolf", "boar", "bull", "bear", "horse", "ram", "stag", "elephant", "rabbit", "antelope", "camel", "tiger", "leopard", "fox", "greyhound", "hedgehog", "badger", "otter", "squirrel", "ass", "cow", "pawPrint", "lizardStatant", "kangarooSalient", "rhinoceros", "llama", "reindeerHead", "reindeerSalient", "hippo", "jerboa", "reindeer", "elephantHead", "monkeyHead", "rat", "squirrelRampant", "ferret", "weasel", "weaselRampant", "wolfHeadAffronty", "cat", "mole", "egg", "testicules", "testiculesPair2", "cockHead", "sheep", "cowHead", "horseSalient", "pig", "lionHeadReguardant", "lionHeadGuardant", "lionLegCouped", "lionLegErased", "lionLeg", "lionCouchant", "lionHeadErased", "lionHead", "lionDormant", "lionSejant", "greyhoundSalient", "greyhoundCourant", "dog", "dogHead", "greyhoundSalientCollared", "dogCouchantGuardant", "polarBear", "bearSejant", "bearStatantErect", "hound"],
  insect: ["bee", "butterfly", "spider", "ant", "grasshopper", "dragonfly", "stagbeetle", "snail", "moth", "hornet", "slug", "beetle", "fly", "wasp", "cricket", "cicada"],
  bird: ["eagle", "falcon", "dove", "raven", "rooster", "crane", "swan", "owl", "peacock", "pelican", "martlet", "crowReguardant", "blackbird", "magpieVolantEnArriere", "storkVolant", "seagullVolant", "shoveller", "starling", "crowHead", "doveFondant", "wing", "ravenHead", "feather", "eagleClaw", "germanEagle", "eagleNatural", "alerionDisplayedTowardsBase", "alerionDisplayed", "alerion", "eagleKleestengel", "eagleLeg", "duck"],
  mythic: ["dragon", "wyvern", "griffin", "unicorn", "pegasus", "hydra", "phoenix", "cockatrice", "basilisk", "sphinx", "salamander", "seadragon", "sealion", "harpy", "centaur", "chimera", "manticore", "ouroboros", "fishtailGriffin", "griffinHead", "bagwyn", "unicornHeadErased", "amphiptere", "chatloup", "mermaidInHerModesty", "chatloupWingedSejant", "dragonHead", "tribalDragon", "dragonHeadCouped", "dragonDormant", "dragonHeadCaboshed", "minotaur"],
  sea: ["dolphin", "serpent", "mermaid", "fish", "pike", "salmon", "whale", "crab", "lobster", "shark", "escallop", "octopus", "narwhal", "shrimp", "whelk", "crabClaw", "seaTurtle", "turtle", "lobsterClaw", "zydrach", "polypus", "dolphinWinged", "manatee", "carpEmbowed", "roachNaissant", "roach", "catfishEmbowed", "luceEmbowed", "catfishHaurientEmbowed", "luce", "snakeGlissant", "snake", "serpentNowed", "serpentErect", "serpentErectTailNowed", "seaSerpent"],
  plant: ["rose", "tree", "lotus", "thistle", "garb", "oak", "oakleaf", "olive", "palm", "lily", "cinquefoil", "quatrefoil", "trefoil", "sunflower", "iris", "poppy", "shamrock", "acorn", "vine", "grapes", "bamboo", "pineapple", "fleur", "lilyPad", "crocus", "sexfoil", "tulip", "octofoil", "violet", "geranium", "tulipBundle3", "periwinkleFlower", "forgetMeNot", "pear", "lemon", "mapleLeaf", "lindenLeaf", "mapleLeafConjoined3", "pineNewEnglandTree", "apple", "lemonSlippedLeaved", "yewTree", "limeLeaf", "seeblatt", "reed", "cloverLeaf", "clover", "reedBundle3", "vineLeaf", "cactus", "wheatEar", "pepper", "bean", "aubergine", "onion", "pumpkin"],
  object: ["crown", "key", "sword", "anchor", "ship", "scales", "harp", "lyre", "book", "bell", "bugle", "clarion", "lute", "drum", "chalice", "amphora", "anvil", "hammer", "millrind", "millstone", "scythe", "sickle", "plough", "pitchfork", "compass", "lantern", "lamp", "scroll", "mirror", "shears", "quill", "distaff", "axe", "halberd", "arrow", "arrows", "pheon", "trident", "spear", "bow", "crossbow", "flail", "club", "cannon", "mace", "warhammer", "catherinewheel", "cartwheel", "cogwheel", "helmet", "gauntlet", "breastplate", "mailedfist", "horseshoe", "spur", "stirrup", "saddle", "wagon", "beehive", "beacon", "brazier", "torch", "grenade", "chest", "crampPair2", "crampBundle3", "wolfiron", "staple", "bobbinLace", "musicalNote", "cClef", "noteQuarter", "noteEighth", "fireSteel", "comb", "bookModernClosed", "candlestick", "vallary", "saxon", "palisado", "antique", "earl", "duke", "quintain", "helmetKnight", "helmetEsquire", "helmetNorman", "helmetPeer", "helmetKnightAffronty", "caltrap", "heraldicCatapult", "archeryTarget", "lance", "dagger", "rapier", "swordstpaul", "sabre", "seax", "slaughterAxe", "pickAxe", "addice", "waterBouget", "mug", "barrel", "scoop", "funnel", "table", "flagOfNum2", "flag", "crystal", "frenchGemstoneInProfile", "stepCutGemstone", "breadloaf", "ham", "cheeseWheel", "arrowBroad", "spearHeadImbrued", "oar", "rudderPole", "oarInsaltire2", "fishingBoat", "crowsNest", "barge", "lymphadFurled", "lymphadSailsSet", "buckle", "maunche", "hoodAffronty", "eyeMask", "stirrupLeathered", "hawkbell", "falconReguardant", "falconJessed", "falconVolant", "farmingFlail", "fishhook", "farmingFlailInsaltire2", "shepherdsCrook", "butterChurn", "ploughshare", "chessPawn", "chessRook", "chessKing", "horn", "heart"],
  ...
  natural: ["cloud", "lightning", "snowflake", "teardrop", "flint", "flames", "fireball", "lightningBoltModern", "rock", "sod", "grassyMound"],
  ...
  geometric: ["mullet", "mullet6", "mullet8", "rowel", "roundel", "annulet", "lozenge", "fusil", "mascle", "billet", "delf", "crossCouped", "crossPattee", "crosslet", "goutte", "fret", "triskele", "knot", "trefoilKnot", "suffolkKnot", "carolingianKnot", "hungerfordKnot", "triangle", "shakefork", "crossFitchy", "crossBarbyFitchy", "crossBarby", "crossFitchyDouble", "crossFitchyDoublePierced", "cossack", "couped", "saltire", "cross", "mulletOf5VoidedInterlaced", "mulletOf7VoidedInterlaced", "mulletOf8MasclesInterlaced", "annuletConcentricOf2", "annuletConcentricOf3", "takedaClanSymbol", "tokikikyoClanSymbol", "moriClanSymbol", "chosokabeClanSymbol"],
};
// @INJECT:MOTIFS-END
