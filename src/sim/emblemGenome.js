...
const MOTIFS = {
  beast: ["lion", "wolf", "boar", "bull", "bear", "horse", "ram", "stag", "elephant", "rabbit", "antelope", "camel", "tiger", "leopard", "fox", "greyhound", "hedgehog", "badger", "otter", "squirrel", "ass", "cow", "lizardStatant", "kangarooSalient", "rhinoceros", "llama", "reindeerHead", "reindeerSalient", "hippo", "jerboa", "reindeer", "elephantHead", "monkeyHead", "rat", "squirrelRampant", "ferret", "weasel", "weaselRampant", "wolfHeadAffronty", "cat", "mole", "cockHead", "sheep", "cowHead", "horseSalient", "pig", "lionHeadReguardant", "lionHeadGuardant", "lionLegCouped", "lionLegErased", "lionLeg", "lionCouchant", "lionHeadErased", "lionHead", "lionDormant", "lionSejant", "greyhoundSalient", "greyhoundCourant", "dog", "dogHead", "greyhoundSalientCollared", "dogCouchantGuardant", "polarBear", "bearSejant", "bearStatantErect"],
  ...
  object: ["crown", "key", "sword", "anchor", "ship", "scales", "harp", "lyre", "book", "bell", "bugle", "clarion", "lute", "drum", "chalice", "amphora", "anvil", "hammer", "millrind", "millstone", "scythe", "sickle", "plough", "pitchfork", "compass", "lantern", "lamp", "scroll", "mirror", "shears", "quill", "distaff", "axe", "halberd", "arrow", "arrows", "pheon", "trident", "spear", "bow", "crossbow", "flail", "club", "cannon", "mace", "warhammer", "catherinewheel", "cartwheel", "cogwheel", "helmet", "gauntlet", "breastplate", "mailedfist", "horseshoe", "spur", "stirrup", "saddle", "wagon", "beehive", "beacon", "brazier", "torch", "grenade", "chest", "crampPair2", "crampBundle3", "wolfiron", "staple", "bobbinLace", "musicalNote", "cClef", "noteQuarter", "noteEighth", "fireSteel", "comb", "bookModernClosed", "candlestick", "vallary", "saxon", "palisado", "antique", "earl", "duke", "quintain", "helmetKnight", "helmetEsquire", "helmetNorman", "helmetPeer", "helmetKnightAffronty", "caltrap", "heraldicCatapult", "archeryTarget", "lance", "dagger", "rapier", "swordstpaul", "sabre", "seax", "slaughterAxe", "pickAxe", "addice", "waterBouget", "mug", "barrel", "scoop", "funnel", "table", "flagOfNum2", "flag", "crystal", "frenchGemstoneInProfile", "stepCutGemstone", "breadloaf", "ham", "cheeseWheel", "arrowBroad", "spearHeadImbrued", "oar", "rudderPole", "oarInsaltire2", "fishingBoat", "crowsNest", "barge", "lymphadFurled", "lymphadSailsSet", "buckle", "maunche", "hoodAffronty", "stirrupLeathered", "hawkbell", "farmingFlail", "fishhook", "farmingFlailInsaltire2", "shepherdsCrook", "butterChurn", "ploughshare", "chessPawn", "chessRook", "chessKing", "horn", "heart"],
