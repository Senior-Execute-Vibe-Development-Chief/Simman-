...
<main>
  ...
  Feature branches publish beside it under <code>/b/…</code> and no longer overwrite each other.
  Music Lab lives at <code>musiclab.html</code> under each channel.</p>
  <section>
    <h2>Live</h2>
