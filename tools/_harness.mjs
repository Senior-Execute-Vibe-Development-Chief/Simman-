...
export function buildSim(opts = {}) {
  ...
  return initPeopleSim(w, { seed: w.seed, tCrop, tFlood: ter.tFlood, tileRes: 1, deposits, tAncestry: ter.tAncestry, terTw: ter.tw, terTh: ter.th, ancestryCount: ter.ancestryCount, ...(opts.simOpts || {}) });
}
