...
export function applyToolTuning() {
  ...
  applyTuning({ POP_FIELD_WORKERS: -1, DAWN_LIVE: 0, STATE_RECORDS: 0, LAND_KNOW: 0, PEER_SEATS: 0, FOUND_DRIFT: 0, ABSORB_ORG_ERA: 0, WAR_FINISH: 0, SETT_STRIDE: 1, TRADE_STRIDE: 3, ...SIM_TUNE_OVERRIDES });
}
applyToolTuning();
