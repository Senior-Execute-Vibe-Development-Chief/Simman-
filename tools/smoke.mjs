...
console.log(`[smoke] DISSOLVE_FARMS lever: no tier-0, deterministic, alive`);
{
  ...
  applyTuning({ DISSOLVE_FARMS: 0, DAWN_LIVE: 0, LAND_KNOW: 0, PEER_SEATS: 0, FOUND_DRIFT: 0, ABSORB_ORG_ERA: 0, TRIBUTE_UP: 0, ENGULF: 0, FEAR_REACH: 0, WAR_FINISH: 0, SMALL_WAR: 0, RELIEF_REACH: 0, SETT_STRIDE: 1, TRADE_STRIDE: 3 });
  try {
  ...
  applyTuning({ DISSOLVE_FARMS: 1, DAWN_LIVE: 0, LAND_KNOW: 0, PEER_SEATS: 0, FOUND_DRIFT: 0, ABSORB_ORG_ERA: 0, TRIBUTE_UP: 0, ENGULF: 0, FEAR_REACH: 0, WAR_FINISH: 0, SMALL_WAR: 0, RELIEF_REACH: 0, SETT_STRIDE: 1, TRADE_STRIDE: 3 });
  try {
