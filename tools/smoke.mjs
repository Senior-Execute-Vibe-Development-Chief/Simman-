...
console.log(`[smoke] DISSOLVE_FARMS lever: no tier-0, deterministic, alive`);
{
  ...
  applyTuning({ DISSOLVE_FARMS: 0, DAWN_LIVE: 0, LAND_KNOW: 0, PEER_SEATS: 0, WAR_FINISH: 0, SETT_STRIDE: 1 });
  try {
  ...
  applyTuning({ DISSOLVE_FARMS: 1, DAWN_LIVE: 0, LAND_KNOW: 0, PEER_SEATS: 0, WAR_FINISH: 0, SETT_STRIDE: 1 });
  try {
